            ...
            <div>
                <ul>
                  ...
                  <b></b>
                    ...
                    <br>
                    <li>Cost: ${{ rocket.cost }} </li>
                    <br>
                    <li>Payload to LEO: ${{ rocket.payloadLeo }} </li>
                    <br>
                    <li>Payload to GTO: ${{ rocket.payloadGto }}</li>
                    <br>
                    <li>Price/KG to LEO: ${{ rocket.kgLeo }} </li>
                    <br>
                    <li>Price/KG to GTO: ${{ rocket.kgGto }} </li>
                </ul>
            </div>
        </v-card-title>
    </v-card>
